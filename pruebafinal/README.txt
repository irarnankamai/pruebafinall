...
a persistence unit "pruebafinalPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "pruebafinal/pom.xml":
...
artifact ("pruebafinal.war") is already built. You can build
